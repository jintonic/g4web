...
/**
 * Polygonal prism solid defined by Z-plane data.
 * Equivalent to Geant4's G4Polyhedra.
 *
 ...
 * @param {number} numSide    - Number of sides in the polygon cross-section
...
class G4Polyhedra extends THREE.BufferGeometry {
  constructor(pName, pSPhi, pDPhi, numSide, numZPlanes, zPlaneData) {
    super();
    ...
    return {
      parameters: {
        ...
        zPlaneData: {
          type: 'zplane',
          label: 'Z Planes',
          default: [-0.8, 0.2, 0.6, 0.5, 0.3, 0.4, 0.8, 0.5, 0.6],
          geometryKey: 'zPlaneData',
        },
      },
      validate: (params) => {
        if (params.numSide < 3) params.numSide = 3;
        return params;
      },
  ...
  toJSON() {
    ...
    data.type = 'G4Polyhedra';
    data.parameters = this.parameters;
    return data;
  }

  static fromJSON(data) {
    const { pName, pSPhi, pDPhi, numSide, numZPlanes, zPlaneData } =
      data.parameters;
